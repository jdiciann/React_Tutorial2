...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createElement(
	    ...
	    React.createElement(Route, { name: 'search', path: 'search/:username', handler: Search }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    var _this = this;
	    BaasBox.loadCollection('notes').done(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NotesList = __webpack_require__(199);
	var AddNote = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddNote = React.createClass({
	  ...
	  handleSubmit: function handleSubmit() {
	    ...
	    var _this = this;
	    BaasBox.save(note1, 'notes').done(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecatedMethod = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    function lib$es6$promise$asap$$attemptVertex() {
	      try {
	        var r = require;
	        var vertx = __webpack_require__(222);
	    ...
	    */
	    ...
	    if ("function" === 'function' && __webpack_require__(223)['amd']) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(220).setImmediate, (function() { return this; }()), __webpack_require__(221)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchGithub = React.createClass({
	  ...
	  handleSubmit: function handleSubmit() {
	    ...
	    this.transitionTo('search', { username: username });
	  },
	  render: function render() {
	    return React.createElement(
	      'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = React.createClass({
	    ...
	    handleSubmit: function handleSubmit() {
	        ...
	        var _this = this;
	        BaasBox.login(email, password).done(function (user) {
	    ...
	    handleSignUp: function handleSignUp() {
	        ...
	        console.log(password);
	        var _this = this;
	        BaasBox.signup(email, password).done(function (user) {
	            console.log('Logged in ', user);
	            _this.transitionTo('search', { username: email });
	        }).fail(function (err) {
	            console.log('error ', err);
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement('input', { className: 'form-control', placeholder: 'yourmail@example.com', ref: 'email', name: 'email', type: 'text' })
	                                ),
	                                React.createElement(
	                                    'div',
	                                    { className: 'form-group' },
	                                    React.createElement('input', { className: 'form-control', placeholder: 'Password', ref: 'password', name: 'password', type: 'password' })
	                                ),
	                                React.createElement(
	                                    'div',
	                                    { className: 'checkbox' },
	                                ...
	                                React.createElement('input', { className: 'btn btn-lg btn-success btn-block', type: 'button', value: 'Login', onClick: this.handleSubmit })
	                            )
	                        ),
	                        ...
	                        React.createElement(
	                            'form',
	                            { action: '', method: 'get' },
	                            React.createElement('input', { className: 'btn btn-lg btn-facebook btn-block', type: 'submit', value: 'Sign up', onClick: this.handleSignUp })
	                        )
	                    )
	                )
	            )
